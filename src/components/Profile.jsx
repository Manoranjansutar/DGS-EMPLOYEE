...
const schema = z.object({
  ...
  profilePic: z.any().refine((file) => file?.length > 0, {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.post(
        "https://dgs-backend-yo9v.onrender.com/api/v1/employee/editEmployee",
        formData,
        {
          headers: {
    ...
    <div className="pt-10 lg:pt-0">
      ...
      <div className="flex flex-col items-center gap-5 lg:flex-row lg:justify-center">
        ...
        <div>
          ...
          <p className="text-xl">
            Employee ID:{" "}
            <span className="mt-2 text-2xl">{employee?.adminId}</span>
          </p>
          <p className="text-xl">
          ...
          <p className="text-xl">
            Aadhar No:{" "}
            <span className="mt-2 text-2xl">{employee?.aadhar_no}</span>
          </p>
          <p className="text-xl">
